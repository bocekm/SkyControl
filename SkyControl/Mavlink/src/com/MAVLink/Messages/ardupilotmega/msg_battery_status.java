...
public class msg_battery_status extends MAVLinkMessage{
	...
	*/
    ...
    public void unpack(MAVLinkPayload payload) {
	    ...
	    this.voltage_cell_1 = payload.getShort();
	    this.voltage_cell_2 = payload.getShort();
	    this.voltage_cell_3 = payload.getShort();
	    this.voltage_cell_4 = payload.getShort();
	    this.voltage_cell_5 = payload.getShort();
	    this.voltage_cell_6 = payload.getShort();
	    this.current_battery = payload.getShort();
	    this.accu_id = payload.getByte();
