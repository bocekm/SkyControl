...
public class msg_setpoint_8dof extends MAVLinkMessage{
	...
	*/
    ...
    public void unpack(MAVLinkPayload payload) {
        payload.resetIndex();
	    this.val1 = payload.getFloat();
	    this.val2 = payload.getFloat();
	    this.val3 = payload.getFloat();
	    this.val4 = payload.getFloat();
	    this.val5 = payload.getFloat();
	    this.val6 = payload.getFloat();
	    this.val7 = payload.getFloat();
	    this.val8 = payload.getFloat();
