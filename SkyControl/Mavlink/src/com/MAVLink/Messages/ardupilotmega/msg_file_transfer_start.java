...
public class msg_file_transfer_start extends MAVLinkMessage{
	...
	*/
    ...
    public void unpack(MAVLinkPayload payload) {
        payload.resetIndex();
	    this.transfer_uid = payload.getLong();
	    this.file_size = payload.getInt();
	    for (int i = 0; i < dest_path.length; i++) {
    ...
    public String toString(){
    	return "MAVLINK_MSG_ID_FILE_TRANSFER_START -"+" transfer_uid:"+transfer_uid+" file_size:"+file_size+" dest_path:"+new String(dest_path)+" direction:"+direction+" flags:"+flags+"";
    }
}
