...
public class msg_state_correction extends MAVLinkMessage{
	...
	*/
    ...
    public void unpack(MAVLinkPayload payload) {
        payload.resetIndex();
	    this.xErr = payload.getFloat();
	    this.yErr = payload.getFloat();
	    this.zErr = payload.getFloat();
	    this.rollErr = payload.getFloat();
	    this.pitchErr = payload.getFloat();
	    this.yawErr = payload.getFloat();
	    this.vxErr = payload.getFloat();
	    this.vyErr = payload.getFloat();
	    this.vzErr = payload.getFloat();    
    }
