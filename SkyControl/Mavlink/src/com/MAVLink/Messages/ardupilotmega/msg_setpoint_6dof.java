...
public class msg_setpoint_6dof extends MAVLinkMessage{
	...
	*/
    ...
    public void unpack(MAVLinkPayload payload) {
        payload.resetIndex();
	    this.trans_x = payload.getFloat();
	    this.trans_y = payload.getFloat();
	    this.trans_z = payload.getFloat();
	    this.rot_x = payload.getFloat();
	    this.rot_y = payload.getFloat();
	    this.rot_z = payload.getFloat();
